...
class RImage
{
	...
	public:
		...
		int16_t SaveDib(const char* pszFileName);
	...
	private:
		...
		int16_t	LoadDib(const char* pszFilename);
...
typedef int16_t (*CONVFROMFUNC)(RImage* pImage);
...
typedef int16_t (*DELETEFUNC)(RImage* pImage);
