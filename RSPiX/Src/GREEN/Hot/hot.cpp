...
//
//		01/15/97	JMI	Do(int16_t) was calling Do(int16_t, int16_t, int16_t) with the
...
//							this got rid of the Do(int16_t sUseQueue) static that
...
//
//////////////////////////////////////////////////////////////////////////////
int16_t	RHot::Do(			// Returns priority of item called back or 
								// RHOT_NO_PRIORITY.
