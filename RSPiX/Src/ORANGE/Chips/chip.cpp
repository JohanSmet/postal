...
//
//////////////////////////////////////////////////////////////////////
int16_t CChip::Slide(long lX, long lY, long lZ, long lRate)
	{
...
//		BLT_FItoBKD(m_pimChip, ms_pimView, (int16_t)m_fX, (int16_t)m_fY);
		}
	else
		{
		...
		for (int16_t	s = 0; s < sHeight; s++)
			{
//			BLT_FItoBKD(m_pimChip, ms_pimView, (int16_t)m_fX, (int16_t)m_fY - s);
