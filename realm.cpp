...
//
//		06/29/97	JMI	Added version of ScaleZ() that takes int16_ts.
...
int16_t CRealm::Load(										// Returns 0 if successfull, non-zero otherwise
	...
	if (sResult == 0) // a success....
		...
		// Kill old...*
		int16_t	sOldW = m_smashatorium.m_sWorldW;
		int16_t	sOldH = m_smashatorium.m_sWorldH;
		int16_t sOldTileW = m_smashatorium.m_sTileW;
		int16_t sOldTileH = m_smashatorium.m_sTileH;
...
/*
void CRealm::Render(
	int16_t sViewX,											// In:  X coord of view
	int16_t sViewY,											// In:  Y coord of view
	int16_t sViewW,											// In:  Width of view
	int16_t sViewH,											// In:  Height of view
	RImage* pimDst,										// In:  Image to render to
	int16_t sDstX,											// In:  X coord to draw to
	int16_t sDstY)											// In:  Y coord to draw to
	{
